                  ...
                  <div class="card-body">
                    <div class="fv-row">
                      ...
                      <div class="fv-row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="monday_locations">
                          <el-select
                  ...
                  <div class="card-body">
                    <div class="fv-row">
                      <div class="row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="tuesday_time">
                          <el-time-picker
                      ...
                      <div class="fv-row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="tuesday_locations">
                          <el-select
                  ...
                  <div class="card-body">
                    <div class="fv-row">
                      <div class="row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="wednesday_time">
                          <el-time-picker
                      ...
                      <div class="fv-row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="wednesday_locations">
                          <el-select
                  ...
                  <div class="card-body">
                    <div class="fv-row">
                      ...
                      <div class="fv-row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="friday_locations">
                          <el-select
                  ...
                  <div class="card-body">
                    <div class="fv-row">
                      <div class="row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="saturday_time">
                          <el-time-picker
                      ...
                      <div class="fv-row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="saturday_locations">
                          <el-select
                ...
                <div class="card border border-primary border-dashed">
                  ...
                  <div class="card-body">
                    <div class="fv-row">
                      <div class="row mb-2">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold mb-2">Time Slot</label>
                        <!--end::Label-->

                        <!--begin::Input-->
                        <el-form-item prop="sunday_time">
                          <el-time-picker
                      ...
                      <div class="fv-row mb-2">
                        ...
                        <!--begin::Input-->
                        <el-form-item prop="sunday_locations">
                          <el-select
