...
import ReportModal from "@/views/patients/ReportTemplateModal.vue";
import LetterModal from "@/views/patients/LetterModal.vue";
import CreateAudioModal from "@/views/patients/CreateAudioModal.vue";
