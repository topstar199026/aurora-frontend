<template>
  ...
  >
    <el-form @submit.prevent :model="formData" :rules="rules">
      <HeadingText text="Details" />

      <div class="row justify-content-md-center">
        <InputWrapper :class="colString" label="Type" prop="type">
          <el-select
            class="w-100"
    ...
    <div class="d-flex justify-content-end">
      ...
      <button class="btn btn-lg btn-secondary" type="submit">Cancel</button>
    </div>
  </ModalWrapper>
</template>
      ...
      switch (formData.value.billing_type) {
        ...
        case 2:
          ...
          validationData.fund_reference_number =
            formData.value.member_reference_number;
          validationData.fund_organisation_code = "TST"; //item.health_fund.code
